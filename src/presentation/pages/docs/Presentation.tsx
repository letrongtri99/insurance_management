...
import { setTheme } from '../../redux/actions/theme/themeActions';
...
function Demo({ dispatch, id, title, img }: any) {
    ...
    <DemoListContent mx={isWidthUp('lg', width) ? -10 : -5} py={10}>
      <Container>
        ...
        <Grid container spacing={6}>
          <ConnectedDemo id={0} title="Rabbit variant" img="dark" />
          <ConnectedDemo id={1} title="Dark variant" img="dark" />
          <ConnectedDemo id={2} title="Light variant" img="light" />
          <ConnectedDemo id={3} title="Blue variant" img="blue" />
          <ConnectedDemo id={4} title="Green variant" img="green" />
          <ConnectedDemo id={5} title="Indigo variant" img="indigo" />
          <ConnectedDemo id={6} title="Teal variant" img="teal" />
        </Grid>
      </Container>
    </DemoListContent>
  );
...
function Presentation({ width }: any) {
  return (
    <>
      <Introduction />
